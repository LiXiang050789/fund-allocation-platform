...
feat_full_df = pd.read_csv(r"E:\农行杯\2026\clean\train_total_feature.csv", parse_dates=["date"], encoding="utf-8-sig")
price_df = pd.read_csv(r"E:\农行杯\2026\clean\etf_price_clean.csv", parse_dates=["date"], encoding="utf-8-sig")
...
# 3、读取标准打分表
std_score_df = pd.read_csv(r"E:\农行杯\2026\clean\market_score_daily.csv", parse_dates=["date"], encoding="utf-8-sig")
...
# 6、输出到clean文件夹，统一路径
out_path = r"E:\农行杯\2026\clean\score_cross_compare.csv"
