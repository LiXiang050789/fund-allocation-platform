import os
import os; _BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
import random
import numpy as np
import torch
...
# 推荐改为与筛选脚本一致
DATA_PATH = _BASE + "/data/clean/train_feature_filtered.csv"
PRICE_PATH = _BASE + "/data/clean/etf_price_clean.csv"
MODEL_SAVE_DIR = _BASE + "/models/multi_model/"
RESULT_SAVE_DIR = _BASE + "/results/multi_model/"
LOG_SAVE_DIR = _BASE + "/logs/train_log/"
...
EPOCH_STEP = 1000   # 原3000 → 6000，单轮总步数翻倍，收敛更充分
RL_WINDOW = 40
