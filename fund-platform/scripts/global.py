...
MODEL_SAVE_DIR = os.path.join(SCRIPT_DIR, "models1", "global_ppo")
RESULT_SAVE_DIR = os.path.join(SCRIPT_DIR, "results1", "global_ppo")
LOG_SAVE_DIR = os.path.join(SCRIPT_DIR, "logs1", "global_ppo_log")
...
REWARD_COEF = (15.0, 0.01, 0.25, 0.005)
